<!doctype html>
<?php $pageTitle = 'dodaj wypożyczenie';
...
if (isset($_POST['czytelnik']) && isset($_POST['ksiazka'])) {
    ...
    if (oci_execute($stmt)) {
        echo '<script> alert("Ksiazka zostala wypozyczona")</script>';
    } else {
        $error = oci_error($stmt);
        echo '<script> alert("Nie udalo sie wypozyczyc ksiazki")</script>';
    }
                ...
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <input class="form-control mr-3" aria-label="Default select example" name='czytelnik' id='czytelnik' required></input>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <input class="form-control mr-3" aria-label="Default select example" name='ksiazka' id='ksiazka' required></input>
